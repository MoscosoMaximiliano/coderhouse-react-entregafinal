  ...
  return (
    <header className='flex justify-between align-middle items-center center p-2 bg-slate-800'>
      ...
      <div className="flex">
        ...
        <a href="#">
          <button className="py-3 px-7 bg-orange-300 text-black border-none rounded cursor-pointer transition-all delay-75 ease-linear hover:bg-orange-500 hover:-translate-y-1 hover:scale-110">
            Contact me!
          </button>
        </a>
      </div>
